...
.welcome__title { font-family: var(--font-display); font-size: 56px; font-weight: 500; color: var(--color-ink); letter-spacing: -0.02em; line-height: 1.05; margin: 0 0 20px; }
.welcome__lede { font-family: var(--font-body); font-size: 17px; line-height: 1.55; color: var(--color-graphite); margin: 0 0 40px; max-width: 560px; }
...
.welcome__actions { display: inline-flex; align-items: center; gap: 20px; }
